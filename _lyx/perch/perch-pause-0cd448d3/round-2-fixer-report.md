...
Read `round-1-review.md` and `round-1-fixer-report.md` after saving this round's
review. Round 1 recorded the identical F1 finding and deferred it unfixed, for the
same reason given below. `evergreen.txt` is unchanged since round 1 (still one line
reading "This fixture is deliberately incomplete forever."), so there is no
