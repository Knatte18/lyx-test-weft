...
- **F1** — [BLOCKING] artifact lacks a formal provenance header
  ...
  marked fixed. This is a standing operator decision governing this round, not a capability gap
  ...
  round. Consistent with round 1's disposition of the same finding — no regression, no change
  in status.
